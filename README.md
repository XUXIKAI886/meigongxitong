...
<div align="center">
  <p>🎨 <strong>美工设计系统 v2.3.1</strong> - 让 AI 为您的外卖生意增光添彩</p>
  <p>🚀 <strong>文件名保持 + Logo Studio修复</strong> | Made with ❤️ by AI Design Team | 2025年10月最新版</p>
  <p>📁 <strong>文件名保持</strong> - 背景融合、多图融合工具下载文件名与源图片一致</p>
  <p>🎯 <strong>Logo Studio修复</strong> - 修复店招/海报/头像生成失败问题，支持Markdown图片链接</p>
  <p>✨ <strong>用户体验提升</strong> - 下载文件名与上传一致，便于商家管理和识别</p>
</div>
